...
mytextclock = lain.widgets.abase({
    ...
    settings = function()
        ...
        for i=1,4 do t_output = t_output .. " " .. o_it(i) end
...
-- Change keyboard dist to dvorak OR es y swap Caps y Ctrl
run_once("setxkbmap es -option ctrl:swapcaps")
